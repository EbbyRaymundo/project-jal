...
public class Start {
	...
	public static void main(String[] args) {
		...
		System.out.println(Decisions.getChoiceFromFullList(6).isAvailable()); // will be false
		System.out.println("test");
		Inventory.addPlayerItem(0); // this is how you add an item. 0 corresponds to the phone
		System.out.println(Decisions.getChoiceFromFullList(6).isAvailable()); // will be true
